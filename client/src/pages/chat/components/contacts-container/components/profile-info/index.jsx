    ...
    <div className="absolute bottom-0 h-16 flex items-center justify-center px-10 w-full bg-[#2a2b33]">
        ...
        <div className="flex gap-2">
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger>
                <FiEdit2 className="text-purple-500 text-xl font-medium relative left-6" onClick={() => navigate('/profile')}/>
              </TooltipTrigger>
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger>
                <IoPowerSharp className="text-red-500 text-xl font-medium relative left-6" onClick={logOut}/>
              </TooltipTrigger>
              <TooltipContent className="bg-[#1c1b1e] border-none text-white">  
                Logout
              </TooltipContent>
