...
const NewDM = () => {
    ...
    const searchContacts = async (searchTerm) => {
      try {
        ...
        console.log("Error in searchContacts:", error.response?.data || error.message); // Debug error
        ...
        <TooltipProvider>
            ...
            <Dialog open={openNewContactModel} onOpenChange={setOpenNewContactModel}>
              <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col">
                ...
                <div>
                  <Input placeholder="Search Contacts" className="rounded-lg p-6 bg-[#2c2e3b] border-none" onChange={e=> searchContacts(e.target.value)} ></Input>
                </div>
